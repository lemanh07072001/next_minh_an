...
import ForgotPassword from "@/app/[locale]/admin/(auth)/login/component/ForgotPassword";
import {
  createFormSchema,
  LoginFormData,
...
export function LoginForm({
  ...
  const handelOpenModalForgotPassword = (open: boolean) => {
    setModalForgotPassword(open);
  };
  return (
    <>
      <ForgotPassword
        openModalForgotPassword={modalForgotPassword}
        onOpenChange={handelOpenModalForgotPassword}
      />
      <div className={cn("flex flex-col gap-6", className)} {...props}>
        <Card>
          <CardHeader className="text-center">
            <CardTitle className="text-xl">{tAuth("LoginTitle")}</CardTitle>
